...
//    }
     ...
     * @return object
     */
    public function getLastRecord($db, $tableName) {
...
//}
     ...
     * @return mixed
     */
    public function deleteLastRecord($db, $tableName) {
        $query = $db->prepare("DELETE FROM $tableName ORDER BY id DESC LIMIT 1");
//    $query->bindParam(':tableName', $tableName, PDO::PARAM_STR);
        return ($query->execute());
    }

    public function generateRandomText($quantity) {
     ...
     * @return mixed
     */
    public function generateRecords($db, $tableName) {
...
//var_dump(getLastRecord($db, 'failed_orders'));
    ...
    public function generateTables($db)
    {
        $r = rand(20, 40);
        $r2 = rand(5, 20);
        $r3 = rand(10, 20);
...
//doWorkOnce($db);
    ...
    public function getLastProduct2($db){
